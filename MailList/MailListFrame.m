...
-(void)setMailList:(MailListModel *)mailList{
    ...
    _nameF = nameFrame;
    _cellHeight = CGRectGetMaxY(nameFrame) + padding;

    //if (mailList.isShow) {
        CGFloat hideViewW =[UIScreen mainScreen].bounds.size.width;
        CGFloat hideViewH = padding + 15+ padding;
        CGFloat hideViewX = 0;
        CGFloat hideViewY = CGRectGetMaxY(nameFrame);
        
        _hideViewF = CGRectMake(hideViewX, hideViewY, hideViewW, hideViewH);
        
        
        CGFloat phoneIconX = nameX;
        CGFloat phoneIconY =  padding;
      ...
      //  _cellHeight = CGRectGetMaxY(_hideViewF) + padding;
    //}
